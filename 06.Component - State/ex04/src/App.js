...
export default function App() {
  const [modal01IsOpen, setModal01IsOpen] = React.useState(false);
  const [modal02IsOpen, setModal02IsOpen] = React.useState(false);
  const [modal03IsOpen, setModal03IsOpen] = React.useState(false);
  const [modal04IsOpen, setModal04IsOpen] = React.useState(false);
  const [modal05IsOpen, setModal05IsOpen] = React.useState(false);
  return (
    <>
      ...
      <Modal
        ...
        style={{
          overlay: {
            backgroundColor: "rgba(0, 0, 666, 0.5)",
          },
          content: {
            color: "orange",
            width: 300,
